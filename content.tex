...
\frametitle{KDE}
\begin{itemize}
  \item es gibt viele Desktop-Manager: KDE, Gnome, XFCE, ...
  \item Desktop-Manager kümmern sich um Fenster, Aussehen von Applikationen, Bedienung % korrekt?
  \item gut konfigurierbar, einheitliches „Look and Feel“
  \item enorm viele „native“ Programme
\end{itemize}
