...
\column{0.3\textwidth}
\begin{itemize}
  \item Alternative zur normalen Konsole: Yakuake
  \item immer über den Shortcut <F12> erreichbar
\end{itemize}

\column{0.7\textwidth}
\begin{figure}
  \includegraphics[width=\textwidth]{yakuake}
  \caption{Yakuake als Konsolen-Ersatz}
\end{figure}
\end{columns}
\end{frame}
